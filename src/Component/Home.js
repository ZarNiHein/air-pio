              ...
              <Row>
                ...
                <Col xs={12} lg={4} style={{justifyContent:"center"}}>
                  ...
                  <Row style={{justifyContent:"center", alignItems:"center"}}>
                    <Col xs={6} md={4} style={{marginLeft:1,marginRight:1}}><Nav.Link style={{backgroundColor: "#383950",width:120, borderRadius:10, fontWeight:"bold", color:"#ffcdba", opacity:0.8,marginTop:20}} onClick={()=>{document.getElementById("PM25AQI").scrollIntoView({behavior:'smooth', block: 'start'})}}>AQI</Nav.Link></Col>
                    <Col xs={6} md={4} style={{marginLeft:1,marginRight:1}}><Nav.Link style={{backgroundColor: "#383950",width:120, borderRadius:10, fontWeight:"bold", color:"#ffcdba", opacity:0.8,marginTop:20}} onClick={()=>{document.getElementById("HealthRisk").scrollIntoView({behavior:'smooth', block: 'start'})}}>Health Risk</Nav.Link></Col>
                    <Col xs={6} md={4} style={{marginLeft:1,marginRight:1}}><Nav.Link style={{backgroundColor: "#383950",width:120, borderRadius:10, fontWeight:"bold", color:"#ffcdba", opacity:0.8,marginTop:20}} onClick={()=>{document.getElementById("Clustering").scrollIntoView({behavior:'smooth', block: 'start'})}}>Clustering</Nav.Link></Col>
                    <Col xs={6} md={4} style={{marginLeft:1,marginRight:1}}><Nav.Link style={{backgroundColor: "#383950",width:120, borderRadius:10, fontWeight:"bold", color:"#ffcdba", opacity:0.8,marginTop:20}} onClick={()=>{document.getElementById("Humidity").scrollIntoView({behavior:'smooth', block: 'start'})}}>Humidity</Nav.Link></Col>
                    <Col xs={6} md={4} style={{marginLeft:1,marginRight:1}}><Nav.Link style={{backgroundColor: "#383950",width:120, borderRadius:10, fontWeight:"bold", color:"#ffcdba", opacity:0.8,marginTop:20}} onClick={()=>{document.getElementById("Beehive").scrollIntoView({behavior:'smooth', block: 'start'})}}>Beehive (Max. Risk Factor)</Nav.Link></Col>
                  </Row>
                </Col>
              </Row>
